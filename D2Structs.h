...
struct BnetData {
    ...
    WORD Unk3;                  // 0x1C 
    BYTE _2;                    // 0x1E
    char szGameName[0x16];      // 0x1F 房间名
    WORD _3;                    // 0x35
    char szGameIP[0x10];        // 0x37 IP
    BYTE _5[0x42];              // 0x47
    DWORD dwId4;                // 0x89 
    char szAccountName[0x30];   // 0x8D 账号名
    char szPlayerName[0x18];    // 0xBD 角色名
    char szRealmName[0x08];     // 0xD5 国度名
    BYTE _8[0x111];             // 0xDD
    BYTE nCharClass;            // 0x1EE
    BYTE nCharFlags;            // 0x1EF
    BYTE nMaxDiff;              // 0x1F0 最大难度
    BYTE _9[0x1F];              // 0x1F1
    BYTE CreatedGameDifficulty; // 0x210 游戏难度
    void* _10;                  // 0x211
    BYTE _11[0x15];             // 0x215
    WORD _12;                   // 0x22A
    BYTE _13;                   // 0x22C
